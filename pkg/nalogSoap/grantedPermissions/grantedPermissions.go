...
import (
	...
	smz_models "github.com/sphera-erp/sphera/pkg/nalogSoap/models/smz"
	"github.com/sphera-erp/sphera/pkg/nalogSoap/pkg/soap"
	"github.com/sphera-erp/sphera/pkg/nalogSoap/smz"
)

func GrantedPermissions(app *app.App, inn string) (string, error) {
	...
	params := smz_models.GetGrantedPermissionsRequest{
		Inn: inn,
	}
