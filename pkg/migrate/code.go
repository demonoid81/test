...
func InstallCodePackage(ctx context.Context, conn *pglx.DB, mergeData map[string]interface{}, codePackage *CodePackage) (err error) {
...
func LockExecTx(ctx context.Context, conn *pglx.DB, sql string) (err error) {
