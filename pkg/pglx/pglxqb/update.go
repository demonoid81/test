...
func (d *updateData) Exec(ctx context.Context) (pgconn.CommandTag, error) {
	if d.RunWith == nil {
...
func (d *updateData) Query(ctx context.Context) (pgx.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *updateData) QueryX(ctx context.Context) (*pglx.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *updateData) QueryRow(ctx context.Context) RowScanner {
	if d.RunWith == nil {
...
func (b UpdateBuilder) QueryX(ctx context.Context) (*pglx.Rows, error) {
	data := builder.GetStruct(b).(updateData)
...
func (b UpdateBuilder) PrefixExpr(expr QB) UpdateBuilder {
...
// From sets a From clause on the query.
func (b UpdateBuilder) From(table string) UpdateBuilder {
	return builder.Set(b, "From", table).(UpdateBuilder)
}
...
func (b UpdateBuilder) SuffixExpr(expr QB) UpdateBuilder {
