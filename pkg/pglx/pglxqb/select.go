...
func (d *selectData) Exec(ctx context.Context) (pgconn.CommandTag, error) {
	if d.RunWith == nil {
...
func (d *selectData) Query(ctx context.Context) (pgx.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *selectData) QueryX(ctx context.Context) (*pglx.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *selectData) QueryRow(ctx context.Context) RowScanner {
	if d.RunWith == nil {
...
func (d *selectData) toSql() (sqlStr string, args []interface{}, err error) {
	...
	if d.From != nil {
		...
		args, err = appendToSql([]QB{d.From}, sql, "", args)
		if err != nil {
			return
		}
	}
...
func (b SelectBuilder) Exec(ctx context.Context) (pgconn.CommandTag, error) {
...
// Query builds and Querys the query with the Runner set by RunWith.
func (b SelectBuilder) QueryX(ctx context.Context) (*pglx.Rows, error) {
	data := builder.GetStruct(b).(selectData)
...
func (b SelectBuilder) PrefixExpr(expr QB) SelectBuilder {
...
func (b SelectBuilder) SuffixExpr(expr QB) SelectBuilder {
