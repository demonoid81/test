...
func (d *deleteData) Exec(ctx context.Context) (pgconn.CommandTag, error) {
	if d.RunWith == nil {
...
func (b DeleteBuilder) Exec(ctx context.Context) (pgconn.CommandTag, error) {
...
func (b DeleteBuilder) PrefixExpr(expr QB) DeleteBuilder {
...
func (b DeleteBuilder) SuffixExpr(expr QB) DeleteBuilder {
...
func (d *deleteData) Query(ctx context.Context) (pgx.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *deleteData) QueryX(ctx context.Context) (*pglx.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
